...
export type CjProofStateCode =
  ...
  | "CJ_STOCK_PROVEN"
  | "CJ_FREIGHT_PROVEN"
  | "CJ_ORDER_DETAIL_PARTIALLY_PROVEN"
...
const LIVE_PROOF_BASELINE = {
  ...
  orderCreate: "UNPROVEN" as const,
  orderDetail: "PARTIALLY_PROVEN" as const,
...
function buildCodes(snapshot: Omit<CjProofStateSnapshot, "codes" | "blockingReasons" | "overall">): CjProofStateCode[] {
  ...
  if (snapshot.orderDetail === "PARTIALLY_PROVEN") codes.push("CJ_ORDER_DETAIL_PARTIALLY_PROVEN");
