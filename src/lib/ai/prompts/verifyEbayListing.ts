...
export function buildVerifyEbayListingPrompt(input: {
  ...
  return [
    ...
    "Do not preserve claims of purchase safety or orderability when CJ order-create proof is missing, limited, or blocked.",
    ...
    "Prefer stable category decisions: when heuristic category confidence is high, do not switch category without strong evidence.",
    "verified_description should remain structured with short sections and bullet points.",
    "Normalize specifics values for ebay-style readability (Brand, Color, Material) and avoid supplier noise.",
