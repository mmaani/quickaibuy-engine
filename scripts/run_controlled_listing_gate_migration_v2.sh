...
echo "[DEPRECATED] run_controlled_listing_gate_migration_v2.sh is deprecated. Use bash scripts/run_controlled_listing_gate_migration.sh (and run 20260309a normalization only if needed for legacy state) instead." >&2
